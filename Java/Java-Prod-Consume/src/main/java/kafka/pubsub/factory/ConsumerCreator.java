...
import kafka.pubsub.utils.CustomDeserializer;
...
public class ConsumerCreator {
    ...
    public static Consumer<String, MessageObj> createConsumer() {
        ...
        Consumer<String, MessageObj> consumer = new KafkaConsumer<>(props);
